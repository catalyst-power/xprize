 ...
 * (AGENTS.md §2, §3). Apps never manage connector lifecycle; the profile
 * owns it.
 *
...
/**
 * Live connector status for the currently acting supplier's own profile
 * (e.g. their own QuickBooks connection).
 */
